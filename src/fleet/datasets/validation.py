"""Path-only dual-branch Dataset for feature extraction / validation (center crop)."""
...
class ImageDatasetForValidation(Dataset):
    """Validation image dataset (dual-branch, no labels)."""

    def __init__(self, image_paths, processor=None, xception_crop_size=128, max_load_warnings=5):
    ...
    def __getitem__(self, idx):
        ...
        return pixel_values_dinov3, pixel_values_xception
